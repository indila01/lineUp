...
<div class="d-flex justify-content-center">
    <div class="my-5 col-lg-7 grid-margin stretch-card">
        <div class="card shadow p-2 mb-5 bg-body rounded">
            <div class="card-body">
                <h4 class="card-title">View Subject Details</h4>
                ...
                <sec:authorize access="hasAuthority('LECTURER')">
                    <a href="#" class="my-2 btn btn-outline-warning rounded-pill" type="button">View my subjects</a>
                </sec:authorize>
                ...
                <table class="table table-hover">
                    ...
                    <c:forEach items="${subjects}" var="subjects">
                        <tr>
                            ...
                            <td>
                                <sec:authorize access="hasAuthority('ADMIN')">
                                    <a href="/subject/removeSubject/${subjects.id}"><i class="fa fa-trash red"
                                                                                       aria-hidden="true"></i></a>
                                </sec:authorize>
                                <a href="/class/viewClassrooms/${subjects.id}"><i class="fas fa-eye red"
